...
public class BusinessPage {
    ...
    public static WebElement sideMenuWebElement;

    @FindBy(how = How.CSS, using = ".header__section--dropdown__title")
    public static WebElement exploreProductsWebElement;

    @FindBy(how = How.CSS, using = ".chaseanalytics-track-link regular-link ")
    public static WebElement chasePPPWebsiteWebElement;
    ...
    public void clickOnSideMenu(){
        sideMenuWebElement.click();
    }

    public void goToPPPWebsite(){
        chasePPPWebsiteWebElement.click();
    }
}
